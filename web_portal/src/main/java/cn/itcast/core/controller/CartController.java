...
public class CartController {
    ...
    public Result addGoodsToCartList(Long itemId, Integer num) {
        ...
        if ("anonymousUser".equals(userName)) {
            ...
            //将购物车转换成json
            String buyerCartJson = JSON.toJSONString(cartList);
            CookieUtil.setCookie(request, response, Constants.COOKIE_CART_LIST, buyerCartJson, 60 * 60 * 24 * 30, "utf-8");
        } else {
    ...
    public List<BuyerCart> findCartList() {
        ...
        String cookieCartJson = CookieUtil.getCookieValue(request, Constants.COOKIE_CART_LIST, "utf-8");
        //3. 如果购物车列表json串为空则返回"[]"
