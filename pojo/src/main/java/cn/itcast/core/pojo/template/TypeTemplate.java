...
public class TypeTemplate implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", tempStatus=").append(tempStatus);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTempStatus() == null ? other.getTempStatus() == null : this.getTempStatus().equals(other.getTempStatus()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTempStatus() == null) ? 0 : getTempStatus().hashCode());
        return result;
    }
}